...
from flask import json,redirect,render_template,flash,request
...
local_server=True
app=Flask(__name__)
app.secret_key="shreedharmurnal"
...
app.config.update(
    ...
    MAIL_PORT='465',
    MAIL_USE_SSL=True,
    MAIL_USERNAME='shreedharsmurnal07@gmail.com',
    MAIL_PASSWORD='wbmhjwaguskwjsto'
)
mail = Mail(app)
